...
svg_l_dst = os.path.join(dst, 'KvLibadwaitaDraft.svg')
svg_d_dst = os.path.join(dst, 'KvLibadwaitaDraftDark.svg')
kvc_l_dst = os.path.join(dst, 'KvLibadwaitaDraft.kvconfig')
kvc_d_dst = os.path.join(dst, 'KvLibadwaitaDraftDark.kvconfig')
